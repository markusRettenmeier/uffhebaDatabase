...
namespace Sammlerplattform.Services
{
    public interface ITrackEvents
    {
        ...
        void TrackWarning(string context = "", Dictionary<string, object>? metrics = null, string? userId = null);
    ...
    public class EventTracker: ITrackEvents
    {
        ...
        public void TrackWarning(string context = "", Dictionary<string, object>? metrics = null, string? userId = null)
        {
            var errorData = new
            {
                Type = "WARNING",
