...
namespace Sammlerplattform.Services.UnitOfWork
{
    ...
    public class UnitOfWork(DbIdentityContext context) : IDisposable, IUnitOfWork
    {
        ...
        //public GenericRepository<ManufacturingDate> ManufactoringDateRepository
        //{
        //    get
        //    {
        //        manufactoringDateRepository ??= new GenericRepository<ManufacturingDate>(context);
        //        return manufactoringDateRepository;
        //    }
        //}
