    ...
    public partial class PhysicalPictureProcessor(IWebHostEnvironment hostEnvironment) : IProcessPicturePhysically
    {
        public (int Statuscode, string Statusmessage) Save(CollectionItemPicture collectionItemPicture, int id, bool update)
        {
            try
            {
                ...
                string pathFile = SaveFileForOCR(collectionItemPicture.Datei, hostEnvironment);
                ...
                return (200, "Bild erfolgreich gespeichert.");
            }
            catch (Exception ex)
            {
                return (500, "Fehler beim Speichern des Bildes: " + ex.Message);
        ...
        public (int Statuscode, string Statusmessage) Delete(int id)
        {
            try
            {
                ...
                return (200, "Bild erfolgreich gelöscht.");
            }
            catch (Exception ex)
            {
                return (500, "Fehler beim Löschen des Bildes: " + ex.Message);
            }
        }
