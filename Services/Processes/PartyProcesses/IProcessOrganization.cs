    ...
    public class OrganizationProcessor(IProcessParty processParty, IUnitOfWork unitOfWork) : IProcessOrganization
    {
        public (int PartyID, int Statuscode, string StatusMessage) CreateOrganization(OrganizationOperationParameterModel organizationOperationParameterModel)
        {
            ...
            PartySearchParameterModel partySearchParameterModel = new()
            {
                ...
                Organization_ProductionFacility_ProductionFacilityName = [organizationOperationParameterModel.Organization.ProductionFacility?.ProductionFacilityName]
            };
            ...
            try
            {
                ...
                scope.Complete();
                return (newOrganization.PartyID, 201, "Organisation erfolgreich erstellt.");
            }
            catch (Exception ex)
            {
        ...
        public (int PartyID, int Statuscode, string StatusMessage) EditOrganization(OrganizationOperationParameterModel organizationOperationParameterModel)
        {
            ...
            {
                return (0, 404, "Partei nicht gefunden.");
            }
            ...
            try
            {
                ...
                scope.Complete();
                return (editedParty.PartyID, 200, "Organisation erfolgreich geändert.");
            }
            catch (Exception ex)
            {
                return (0, 500, "Es ist ein Fehler aufgetreten: " + ex.Message + " " + ex.InnerException);
