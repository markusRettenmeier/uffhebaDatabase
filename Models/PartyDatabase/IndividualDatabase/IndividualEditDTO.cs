...
namespace Sammlerplattform.Models.PartyDatabase.IndividualDatabase
{
    ...
    {
        [Required(ErrorMessageResourceName = "Error_PartyID_Missing", ErrorMessageResourceType = typeof(SharedResources))]
        ...
        public List<ConnectedPlaceEditDTO> ConnectedPlaceList { get; set; } = [];
    }
    public class ConnectedPlaceEditDTO
    {
