...
async function register() {
    ...
    try {
        ...
        btnRegister.innerHTML = '<span class="spinner-border spinner-border-sm me-2" role="status"></span>Wird vorbereitet...';
        ...
        btnRegister.innerHTML = '<span class="spinner-border spinner-border-sm me-2" role="status"></span>Wird abgeschlossen...';
